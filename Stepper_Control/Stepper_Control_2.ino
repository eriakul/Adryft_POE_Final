...
const int MOTOR_STEP_PIN1 = 54;
const int MOTOR_DIRECTION_PIN1 = 55;
const int STEPPER_ENABLE_PIN1 = 38;
...
void loop()
{
  ...
  while (Serial.available())
  {
    if (Serial.available() > 0)
    {
      ...
      stepper1.moveRelativeInRevolutions(moveRevolutions(radius2, theta2));
