...
while not done:
    ...
    if check:
        check1, next_peg1, move_type1 = get_next_peg(peg_list_card)
        check2, next_peg2, move_type2 = get_next_peg(peg_list_card)
